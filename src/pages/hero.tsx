...
export default function hero() {
    ...
    return (
        <div className="z-0 relative bg-bp_back bg-[url(/bg_tex.svg)] bg-repeat bg-[_5rem] h-svh">
            ...
            */}
            ...
            <div className="relative mx-auto max-w-2xl pt-24 pb-16">
                ...
                <div className="z-10 relative h-[15rem]">
                    <div className="absolute top-1/1 left-1/2 -translate-x-1/2 -translate-y-1/1 h-[20vh] w-screen overflow-visible">
                        <div className="relative -top-[14rem] left-1/2 -translate-x-1/2 bg-[url(/linetrace_bp.svg)] bg-no-repeat bg-auto bg-center bg-[left_-15rem_center] h-[90rem] aspect-video">
                        </div>
                    </div>
                </div>
            ...
            <div className="z-40 absolute bottom-0 left-1/2 -translate-x-1/2 mb-0 bg-[url(/ScrollPrompt.svg)] bg-no-repeat bg-contain bg-center w-[5rem] aspect-square animate-bounce">
